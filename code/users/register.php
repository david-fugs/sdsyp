...
<body>
    ...
    if (isset($_REQUEST['usuario'])) {
        ...
        $id_grupo = isset($_REQUEST['id_grupo']) ? intval($_REQUEST['id_grupo']) : 0;

        $query = "INSERT INTO `usuarios` (usuario, password, nombre, id_grupo,estado_usu) VALUES ('$usuario', '" . sha1($password) . "','$nombre', '$id_grupo',1)";
        ...
        if ($result) {
            echo "<div class='success-message'>
                    ...
                    <br><br>
                    <a href='../../index.php' class='btn btn-light btn-modern' style='margin-top: 15px;'>
                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-md-6">
                            <label for="nombre" class="form-label">
                                <i class="bi bi-person"></i> * NOMBRES USUARIO:
                            </label>
                            <input type="text"
                                name="nombre"
                                class="form-control"
                        ...
                        <div class="col-12 col-md-6">
                            <label for="id_grupo" class="form-label">
                                <i class="bi bi-building"></i> * CENTRO ASOCIADO:
                            </label>
                            <select name="id_grupo" id="id_grupo" class="form-control" required style="font-size: 20px; height: 50px;">
