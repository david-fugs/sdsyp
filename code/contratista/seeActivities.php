...
function deleteMember($id_meta)
{
    ...
    $query = "DELETE FROM actividad_contratista WHERE id_actividad_contratista = ?";
...
<body>
    ...
    <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em; font-size: 48px; text-align: center; font-weight: bold;"><b><i
                class="bi bi-target"></i> ACTIVIDADES</b></h1>
    ...
    <div class="container mt-5">
        <div class="modern-container">
            ...
            <div class="modern-header">
                <h2><i class="bi bi-target"></i> Actividades Registradas</h2>
