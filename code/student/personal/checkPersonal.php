...
<body>
    ...
    <section class="principal">
        ...
        <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
            ...
            <div class="flex">
                <div class="box">
                    <form action="checkPersonal.php" method="get">
            ...
            <div class="d-flex justify-content-center " >
                ...
                <a  class="ml-4" href="../exportar/exportarAllPersonal.php"><img src='../../../img/excel.png' width="75" height="80" title="Regresar" /></a>
            </div>
            <?php
    ...
    <tr>
        ...
        <td data-label="APLICADA EL">' . $row['fecha_dig_personal'] . '</td>
