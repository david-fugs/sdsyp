...
<body>
   	...
   	<?php
	    ...
	    if(isset($_POST['btn-update']))
        {
            ...
            $fecha_edit_prePostnatales          =   date('Y-m-d h:i:s');
            $id_usu                             =   $_SESSION['id'];

           
            $update = "UPDATE prePostnatales SET fecha_dig_prePostnatales='".$fecha_dig_prePostnatales."', mun_dig_prePostnatales='".$mun_dig_prePostnatales."', nombre_encuestador_prePostnatales='".$nombre_encuestador_prePostnatales."', rol_encuestador_prePostnatales='".$rol_encuestador_prePostnatales."', edad_madre_prePostnatales='".$edad_madre_prePostnatales."', gestacion_meses_prePostnatales='".$gestacion_meses_prePostnatales."', embarazo_mama_prePostnatales='".$embarazo_mama_prePostnatales."', lactancia_mama_prePostnatales='".$lactancia_mama_prePostnatales."', gateo_prePostnatales='".$gateo_prePostnatales."', camino_prePostnatales='".$camino_prePostnatales."', fecha_edit_prePostnatales='".$fecha_edit_prePostnatales."', id_usu='".$id_usu."' WHERE num_doc_est='".$num_doc_est."'";
