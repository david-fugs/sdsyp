    ...
    <script>
       function cambiarEstado(num_doc_est) {
            if (confirm('¿Está seguro que desea cambiar el estado del estudiante?')) {
                window.location.href = 'cambiarEstado.php?num_doc_est=' + num_doc_est + '&campo=' + 'preguntas' + '&valor=' + 1;
            }
        }

        function cesados() {
            window.location.href = 'showQuestionsCesados.php';
        }
    </script>
</head>
...
<body>
    ...
    <section class="principal">
        ...
        <div class="flex">
            <div class="box">
                <form action="showQuestions.php" method="get">
        ...
        $query = "SELECT estudiantes.*, usuarios.*, ie.*
          ...
          AND (estudiantes.grado_est LIKE '%$grado_est%')
                      AND estudiantes.estado_preguntas = 0
