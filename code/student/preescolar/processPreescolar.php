...
$sql = "INSERT INTO preescolar (
    fecha_dig_preescolar,
    mun_dig_preescolar,
    nombre_encuestador_preescolar,
    rol_encuestador_preescolar,
    num_doc_est,
    nom_ape_est,
    p1_eleccion_preescolar,
    p1_consecuen_preescolar,
    p1_independencia_preescolar,
    p1_artistico_preescolar,
    p1_lugarvive_preescolar,
    p1_rolfamilia_preescolar,
    p1_escucha_preescolar,
    p2_juegos_preescolar,
    p2_palabras_preescolar,
    p2_crea_preescolar,
    p2_leer_preescolar,
    p2_escribir_preescolar,
    p3_concentracion_preescolar,
    p3_explica_preescolar,
    p3_participa_preescolar,
    p3_identifica_preescolar,
    p3_acontecimientos_preescolar,
    p3_cuerpo_preescolar,
    p3_secuencia_preescolar,
    p3_atributo_preescolar,
    p3_enumeracion_preescolar,
    estado_preescolar
) VALUES (
    '$fecha_dig_preescolar',
    '$mun_dig_preescolar',
