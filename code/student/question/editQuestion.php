...
<body>
    ...
    if (isset($_GET['num_doc_est'])) {
        ...
        $sql_formulario = mysqli_query($mysqli, "SELECT * FROM preguntas WHERE num_doc_est = '$num_doc_est'");
    ...
    <div class="container">
        ...
        <form action='editQuestion1.php' method="POST">
                        ...
                        <select name='mun_dig_preguntas' class='form-control' id='selectMunicipio' required>
                            ...
                            ?>
                                <option value='<?php echo $row1['nombre_mun']; ?>'
                                    <?php if ($res_formulario['mun_dig_preguntas'] == $row1['nombre_mun']) {
                                        echo 'selected';
                                    } ?>>
                ...
                <div class="row">
                    <div class="col-6 col-sm-4 mt-4">
                        ...
                        <select class="form-control" name="bueno_preguntas" id="bueno_preguntas">
                            <option value=""></option>
                            <option value="deporte" <?php if ($res_formulario['bueno_preguntas'] == "deporte") {
                                                        echo 'selected';
                                                    } ?>>DEPORTE</option>
                            <option value="artistica" <?php if ($res_formulario['bueno_preguntas'] == "artistica") {
                                                            echo 'selected';
                                                        } ?>>ARTISTICA</option>
                            <option value="liderazgo" <?php if ($res_formulario['bueno_preguntas'] == "liderazgo") {
                                                            echo 'selected';
                                                        } ?>>LIDERAZGO</option>
                            <option value="ciencia" <?php if ($res_formulario['bueno_preguntas'] == "ciencia") {
                                                        echo 'selected';
                                                    } ?>>CIENCIA</option>
                            <option value="tecnologia" <?php if ($res_formulario['bueno_preguntas'] == "tecnologia") {
                                                            echo 'selected';
                                                        } ?>>TECNOLOGIA</option>
                            <option value="ocio" <?php if ($res_formulario['bueno_preguntas'] == "ocio") {
                                                        echo 'selected';
                                                    } ?>>OCIO</option>
                            <option value="estudio" <?php if ($res_formulario['bueno_preguntas'] == "estudio") {
                                                        echo 'selected';
                                                    } ?>>ESTUDIO</option>
                            <option value="video juegos" <?php if ($res_formulario['bueno_preguntas'] == "video juegos") {
                                                                echo 'selected';
                                                            } ?>>VIDEO JUEGOS</option>
                            <option value="otro" <?php if ($res_formulario['bueno_preguntas'] == "otro") {
                                                        echo 'selected';
                                                    } ?>>OTRO</option>
                        </select>
                    </div>
                    <div class="col-6 col-sm-4 mt-4">
                        ...
                        <select class="form-control" name="grande_preguntas" id="grande_preguntas">
                            <option value=""></option>
                            <option value="profesional" <?php if ($res_formulario['grande_preguntas'] == "otro") {
                                                            echo 'selected';
                                                        } ?>>PROFESIONAL</option>
                            <option value="empresario" <?php if ($res_formulario['grande_preguntas'] == "empresario") {
                                                            echo 'selected';
                                                        } ?>>EMPRESARIO</option>
                            <option value="madre o padre" <?php if ($res_formulario['grande_preguntas'] == "madre o padre") {
                                                                echo 'selected';
                                                            } ?>>MADRE O PADRE DE FAMILIA</option>
                            <option value="agricultor" <?php if ($res_formulario['grande_preguntas'] == "agricultor") {
                                                            echo 'selected';
                                                        } ?>>AGRICULTOR</option>
                            <option value="migrar" <?php if ($res_formulario['grande_preguntas'] == "migrar") {
                                                        echo 'selected';
                                                    } ?>>MIGRAR</option>
                            <option value="militar" <?php if ($res_formulario['grande_preguntas'] == "militar") {
                                                        echo 'selected';
                                                    } ?>>MILITAR</option>
                            <option value="independiente" <?php if ($res_formulario['grande_preguntas'] == "independiente") {
                                                                echo 'selected';
                                                            } ?>>INDEPENDIENTE</option>
                            <option value="ama de casa" <?php if ($res_formulario['grande_preguntas'] == "ama de casa") {
                                                            echo 'selected';
                                                        } ?>>AMA DE CASA</option>
                            <option value="influencer" <?php if ($res_formulario['grande_preguntas'] == "influencer") {
                                                            echo 'selected';
                                                        } ?>>INFLUENCER</option>
                            <option value="otro" <?php if ($res_formulario['grande_preguntas'] == "otro") {
                                                        echo 'selected';
                                                    } ?>>OTRO</option>
                        </select>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 mt-4 ">
                        ...
                        <select class="form-control" name="gustar_preguntas" id="gustar_preguntas">
                            <option value=""></option>
                            <option value="bailar" <?php if ($res_formulario['gustar_preguntas'] == "bailar") {
                                                        echo 'selected';
                                                    } ?>>BAILAR</option>
                            <option value="leer" <?php if ($res_formulario['gustar_preguntas'] == "leer") {
                                                        echo 'selected';
                                                    } ?>>LEER</option>
                            <option value="cocinar" <?php if ($res_formulario['gustar_preguntas'] == "cocinar") {
                                                        echo 'selected';
                                                    } ?>>COCINAR</option>
                            <option value="pasear" <?php if ($res_formulario['gustar_preguntas'] == "pasear") {
                                                        echo 'selected';
                                                    } ?>>PASEAR</option>
                            <option value="video juegos" <?php if ($res_formulario['gustar_preguntas'] == "video juegos") {
                                                                echo 'selected';
                                                            } ?>>VIDEO JUEGOS</option>
                            <option value="redes sociales" <?php if ($res_formulario['gustar_preguntas'] == "redes sociales") {
                                                                echo 'selected';
                                                            } ?>>REDES SOCIALES</option>
                            <option value="estar con amigos" <?php if ($res_formulario['gustar_preguntas'] == "estar con amigos") {
                                                                    echo 'selected';
                                                                } ?>>ESTAR CON AMIGOS</option>
                            <option value="conducir" <?php if ($res_formulario['gustar_preguntas'] == "conducir") {
                                                            echo 'selected';
                                                        } ?>>CONDUCIR</option>
                            <option value="deportes" <?php if ($res_formulario['gustar_preguntas'] == "deportes") {
                                                            echo 'selected';
                                                        } ?>>DEPORTES</option>
                            <option value="otro" <?php if ($res_formulario['gustar_preguntas'] == "otro") {
                                                        echo 'selected';
                                                    } ?>>OTRO</option>
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-6 col-sm-12 mt-4">
                        ...
                        <input class="form-control" type="text" name="recomendacion_preguntas"
                            value="<?php echo isset($res_formulario['recomendacion_preguntas']) ? htmlspecialchars($res_formulario['recomendacion_preguntas']) : ''; ?>">
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="consentimiento_preguntas" id="consentimiento_preguntas">
                    <option value=""></option>
                    <option value="si"  <?php if ($res_formulario['consentimiento_preguntas'] == "si") {
                                                                echo 'selected';
                                                            } ?>>SI</option>
                    <option value="no" <?php if ($res_formulario['consentimiento_preguntas'] == "no") {
                                                                echo 'selected';
                                                            } ?>>NO</option>
                </select>
            </div>
            <div class="form-group">
                    <input type="hidden" name="id_registro" value="<?= $res_formulario['id_preguntas'] ?>">
                </div>
