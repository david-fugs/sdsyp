...
<body>
    ...
    if (isset($_POST)) {
        ...
        $id_preguntas                     = $_POST['id_registro'];
        $fechaedicion_preguntas              = date("Y-m-d H:i:s");
        // Consulta SQL para realizar el UPDATE
        $sql = "UPDATE preguntas SET 
    fecha_dig_preguntas = '$fecha_dig_preguntas',
    mun_dig_preguntas = '$mun_dig_preguntas',
    nombre_encuestador_preguntas = '$nombre_encuestador_preguntas',
    rol_encuestador_preguntas = '$rol_encuestador_preguntas',
    num_doc_est = '$num_doc_est',
    nom_ape_est = '$nom_ape_est',
    bueno_preguntas = '$bueno_preguntas',
    grande_preguntas = '$grande_preguntas',
    gustar_preguntas = '$gustar_preguntas',
    recomendacion_preguntas = '$recomendacion_preguntas',
    consentimiento_preguntas = '$consentimiento_preguntas',
    fechaedicion_preguntas = '$fechaedicion_preguntas'
