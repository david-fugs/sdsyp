...
<body>
   	...
   	<?php
	    ...
	    if(isset($_POST['btn-update']))
        {
            ...
            $trastorno_est          =   $_POST['trastorno_est'];
            $etnia_est              =   $_POST['etnia_est'];
            $victima_est            =   $_POST['victima_est'];
            $jornada_est            =   $_POST['jornada_est'];
            $caracter_media_est     =   $_POST['caracter_media_est'];
            $especialidad_caracter_est  =   $_POST['especialidad_caracter_est'];
            $grado_est              =   $_POST['grado_est'];
            $nom_grado_est          =   $_POST['nom_grado_est']; 
            $estado_est             =   1;
            ...
            echo $update = "UPDATE estudiantes SET tip_doc_est='".$tip_doc_est."', fecha_dig_est='".$fecha_dig_est."', mun_dig_est='".$mun_dig_est."', nom_ape_est='".$nom_ape_est."', fec_nac_est='".$fec_nac_est."', ciu_nac_est='".$ciu_nac_est."', dir_est='".$dir_est."', mun_res_est='".$mun_res_est."', estrato_est='".$estrato_est."', zona_est='".$zona_est."', tel1_est='".$tel1_est."', tel2_est='".$tel2_est."', email_est='".$email_est."', est_civ_est='".$est_civ_est."', gen_est='".$gen_est."', eps_est='".$eps_est."', med_trans_est='".$med_trans_est."', sisben_est='".$sisben_est."', cod_dane_ieSede='".$cod_dane_ieSede."', obs_est='".$obs_est."', poblacion_vulnerable_est='".$poblacion_vulnerable_est."', discapacidad_est='".$discapacidad_est."', capacidad_est='".$capacidad_est."', trastorno_est='".$trastorno_est."', etnia_est='".$etnia_est."', victima_est='".$victima_est."', jornada_est='".$jornada_est."', caracter_media_est='".$caracter_media_est."', especialidad_caracter_est='".$especialidad_caracter_est."', grado_est='".$grado_est."', nom_grado_est='".$nom_grado_est."', estado_est='".$estado_est."', nombre_encuestador_est='".$nombre_encuestador_est."', rol_encuestador_est='".$rol_encuestador_est."', fecha_edit_est='".$fecha_edit_est."', id_usu='".$id_usu."' WHERE num_doc_est='".$num_doc_est."'";
                ...
                <!DOCTYPE html>
                    <html lang='es'>
                        ...
                        <body>
                            ...
                            <div class='container'>
                                <br />
                                <h3><b><i class='fa-solid fa-address-card'></i> SE ACTUALIZÓ DE FORMA EXITOSA EL REGISTRO</b></h3><br />
