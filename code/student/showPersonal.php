    ...
    <script>
         function cambiarEstado(num_doc_est) {
            if (confirm('¿Está seguro que desea cambiar el estado del estudiante?')) {
                window.location.href = 'cambiarEstado.php?num_doc_est=' + num_doc_est + '&campo=' + 'personal' + '&valor=' + 1;
            }
        }

        function cesados() {
            window.location.href = 'showPersonalCesados.php';
        }
    </script>
</head>
...
<body>
    ...
    <section class="principal">
        ...
        $query = "SELECT estudiantes.*, usuarios.*, ie.*
          ...
          AND estudiantes.estado_personal = 0  
