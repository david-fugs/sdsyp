    ...
    <body>
		...
		<section class="principal">
			...
			<div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
				...
				<div align="center">
					<h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fa-solid fa-person-pregnant"></i> DATOS PRE Y POSTNATALES</b></h1>
				</div>
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo '
				<tr>
					...
					<td data-label="ACTUALIZAR"><a href="addstudentedit.php?num_doc_est='.$row['num_doc_est'].'"><img src="../../img/baby.png" width=32 height=32></a></td>
