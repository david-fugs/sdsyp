...
<body>
    ...
    <section class="principal">
        ...
        <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
            ...
            <div class="flex">
                <div class="box">
                    <form action="checkPerformance.php" method="get">
            ...
            <div class="d-flex justify-content-center " >
                ...
                <a  class="ml-4" href="exportar/exportarAllPerform.php"><img src='../../img/excel.png' width="75" height="80" title="Regresar" /></a>
            </div>
            <?php
        ...
        <div class='card-body'>
            ...
            $consulta = "SELECT desempeno.*, estudiantes.*, ie.*, COUNT(desempeno.num_doc_est) as veces_aplicada 
             FROM desempeno 
             ...
             AND (estudiantes.nom_ape_est LIKE '%$nom_ape_est%') 
             AND (estudiantes.grado_est LIKE '%$grado_est%')
             AND fechacreacion_desempeno >= '2023-10-01' 
             AND ie.cod_dane_ie = $cod_dane_ie 
             GROUP BY desempeno.num_doc_est 
            ...
            <tr>
                ...
                <td data-label="APLICADA EL">' . $row['fechacreacion_desempeno'] . '</td>
                <td data-label="REALIZÓ">' . utf8_encode($row['nombre_encuestador_desempeno']) . '</td>
                <td data-label="MODIFICADA EL">' . $row['fechaedicion_desempeno'] . '</td>
                <td data-label="VECES APLICADA" class="' . $veces_clase . '">' . $row['veces_aplicada'] . '</td>
                <td data-label="VER ENCUESTAS"><a href="viewPerformanceSurvey.php?num_doc_est=' . $row['num_doc_est'] . '"><img src="../../img/search.png" width=28 height=28></a></td>
                <td data-label="EXPORTAR"><a href="exportar/exportarSurveysPerformance.php?num_doc_est=' . $row['num_doc_est'] . '"><img src="../../img/excel.png" width=32 height=32></a></td>
            </tr>';
            }
