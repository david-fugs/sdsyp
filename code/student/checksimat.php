...
<html lang="es">
    ...
    <section class="principal">
        ...
        <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
            ...
            <div align="center">
                <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fa-solid fa-address-card"></i> ESTUDIANTES ACTUALIZADOS - SIMAT</b></h1>
            </div>
        ...
        <div class="flex">
            <div class="box">
                <form action="checksimat.php" method="get" class="form">
	...
	if ($res) {
		...
		echo '
				<tr>
					...
					<td data-label="FEC. ACTUA.">'.$row['fecha_edit_est'].'</td>
					<td data-label="ACTUALIZÓ">'.utf8_encode($row['nombre_encuestador_est']).'</td>
				</tr>';
			$i++;
        }
