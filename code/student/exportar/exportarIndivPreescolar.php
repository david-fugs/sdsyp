...
if (!isset($_GET['id_preescolar'])) {
    header('Location: ../../../index.php');
}
$id_preescolar = $_GET['id_preescolar'];
...
$sql = "SELECT * FROM preescolar WHERE id_preescolar = $id_preescolar";
...
while ($row = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
    ...
    $sheet->setCellValue('C2', $row['mun_dig_preescolar']);
    $sheet->setCellValue('D2', $row['nombre_encuestador_preescolar']);


    $sheet->setCellValue('E2', $row['p1_eleccion_preescolar']);
    $sheet->setCellValue('F2', $row['p1_consecuen_preescolar']);
    $sheet->setCellValue('G2', $row['p1_independencia_preescolar']);
    $sheet->setCellValue('H2', $row['p1_artistico_preescolar']);
    $sheet->setCellValue('I2', $row['p1_lugarvive_preescolar']);
    $sheet->setCellValue('J2', $row['p1_rolfamilia_preescolar']);
    $sheet->setCellValue('K2', $row['p1_escucha_preescolar']);

    $sheet->setCellValue('L2', $row['p2_juegos_preescolar']);
    $sheet->setCellValue('M2', $row['p2_palabras_preescolar']);
    $sheet->setCellValue('N2', $row['p2_segmenoral_preescolar']);
    $sheet->setCellValue('O2', $row['p2_crea_preescolar']);
    $sheet->setCellValue('P2', $row['p2_leer_preescolar']);
    $sheet->setCellValue('Q2', $row['p2_escribir_preescolar']);

    $sheet->setCellValue('R2', $row['p3_concentracion_preescolar']);
    $sheet->setCellValue('S2', $row['p3_explica_preescolar']);
    $sheet->setCellValue('T2', $row['p3_participa_preescolar']);
    $sheet->setCellValue('U2', $row['p3_identifica_preescolar']);
    $sheet->setCellValue('V2', $row['p3_acontecimientos_preescolar']);
    $sheet->setCellValue('W2', $row['p3_cuerpo_preescolar']);
    $sheet->setCellValue('X2', $row['p3_secuencia_preescolar']);
    $sheet->setCellValue('Y2', $row['p3_atributo_preescolar']);
    $sheet->setCellValue('Z2', $row['p3_enumeracion_preescolar']);
}
