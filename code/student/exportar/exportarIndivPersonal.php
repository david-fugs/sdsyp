...
while ($row = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
    ...
    $nombreEst = $row['nom_ape_est'];
     ...
     $sheet->setCellValue('C2', $row['mun_dig_personal']);
     $sheet->setCellValue('D2', $row['nombre_encuestador_personal']);


    $sheet->setCellValue('E2', $row['normas_personal']);
    $sheet->setCellValue('F2', $row['acata_personal']);
    $sheet->setCellValue('G2', $row['interactua_personal']);
    $sheet->setCellValue('H2', $row['cuidado_personal']);
    $sheet->setCellValue('I2', $row['observacion_personal']);
