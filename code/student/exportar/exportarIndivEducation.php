...
$sql = "SELECT * FROM educacion WHERE id_educacion = $id_educacion";
...
while ($row = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
    ...
    $sheet->setCellValue('C2', $row['mun_dig_educacion']);
    $sheet->setCellValue('D2', $row['nombre_encuestador_educacion']);
    $sheet->setCellValue('E2', Si1No2($row['vinculacion_inst_educacion']));
    $sheet->setCellValue('F2', $row['nom_inst_educacion']);
    $sheet->setCellValue('G2', $row['modalidad_inst_educacion']);
    $sheet->setCellValue('H2', Si1No2($row['complementario_educacion']));
    $sheet->setCellValue('I2', $row['program_complement_educacion']);
    $sheet->setCellValue('J2', Si1No2($row['repetir_year_educacion']));
    $sheet->setCellValue('K2', $row['anios_repet_educacion']);
    $sheet->setCellValue('L2', Si1No2($row['talento_educacion']));
    $sheet->setCellValue('M2', $row['talento_descrip_educacion']);
    $sheet->setCellValue('N2', Si1No2($row['vinculacion_club_educacion']));
    $sheet->setCellValue('O2', $row['club_descrip_educacion']);
    $sheet->setCellValue('P2', $row['fechacreacion_educacion']);
    $sheet->setCellValue('Q2', $row['fechaedicion_educacion']);
