...
<body>
    ...
    <div class="container">
        ...
        <form action='editfamiliasalud1.php' method="POST">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <?php
                    //formulario
                    $sql_formulario = "SELECT * FROM familiasalud WHERE id_salud_familiaSalud = '$id_registro'";
                    $res_formulario =  mysqli_fetch_array($sql);
                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-bordered table-info">
                            ...
                            <tbody>
                                <tr>
                                    <td>Madre</td>
                                    <td><input type="radio" name="relacion_madre_familiaSalud" value="satisfactorias" <?php if($res_formulario['edad_madre_prePostnatales']=='10'){echo 'selected';} ?>></td>
