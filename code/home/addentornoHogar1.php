...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $vive_madre_hog = mysqli_real_escape_string($mysqli, $_POST['vive_madre_hog']);
    ...
    $vive_padre_hog = mysqli_real_escape_string($mysqli, $_POST['vive_padre_hog']);
    ...
    if (mysqli_query($mysqli, $sql_update)) {
        ...
        echo "<script>alert('Error al actualizar la información: " . mysqli_error($mysqli) . "'); window.location.href = 'showentornoHogar.php';</script>";
    }
}
?>
