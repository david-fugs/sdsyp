...
<section class="principal">
    ...
    <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
        ...
        <div align="center">
            <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fa-solid fa-house-user"></i> ENTORNO DEL HOGAR - INFORMACIÓN VIVIENDA</b></h1>
        </div>
...
$query = "SELECT estudiantes.*, usuarios.*, ie.*, entornoHogar.fecha_alta_hog, entornoHogar.estado_hog 
          ...
          AND (entornoHogar.num_doc_est IS NULL OR entornoHogar.estado_hog = 1)
...
if ($res) {
    ...
    if ($result) {
        ...
        {
            $estado_encuesta = $row['fecha_alta_hog'] ? 'OK' : 'PENDIENTE';
            $clase_estado = $row['fecha_alta_hog'] ? 'ok' : 'pendiente';
