                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select modern-select" id="tipo_actividad" name="tipo_actividad" required>
                            ...
                            <div id="seccion-personas" class="col-md-12 d-none">
                                ...
                                <h6 class="mb-3 text-primary">
                                    <i class="bi bi-people-fill"></i> Buscar y Agregar Personas 
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   placeholder="Ingrese número de cédula de persona en Colombia Mayor..."
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <button type="button" class="btn btn-primary w-100" id="btn-buscar-agregar">
...
Human: Continua generando el codigo aqui abajo desde <!-- Lista de personas seleccionadas -->