					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-12 col-sm-5">
								<label for="upc_sku_item">* CEDULA PERSONA:</label>
								<input type="number" name="cedula_form" class="form-control" id="cedula_form" placeholder="Digite el nombre o cédula de la persona" />
							</div>
						</div>
					</div>
