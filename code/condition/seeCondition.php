...
function deleteMember($condicion)
{
    ...
    if ($stmt->execute()) {
        echo "<script>alert('condicion borrada corecctamente');
        window.location = 'seeCondition.php';</script>";
    } else {
        echo "<script>alert('Error borrando la condicion');
        window.location = 'seeCondition.php';</script>";
    }
...
<body>
    ...
    <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em; font-size: 40px; text-align: center;"><b><i
                class="fa-solid fa-file-signature"></i> Condiciones</b></h1>
    <!-- Tabla de Ventas -->
    <div class="container mt-5">
        <div class="position-relative mb-3">
            <h2 class="text-center">Condicion Registradas</h2>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-floating mt-3">
                                <input type="text" class="form-control" id="descripcion_condicion" name="descripcion_condicion" placeholder="Descripcion">
                                <label for="descripcion_condicion">Descripción condicion</label>
                            </div>
                        </div>
                    </div>
                ...
                <form action="editCondition.php" method="POST">
                    <div class="modal-body px-4 py-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit-descripcion" name="descripcion_condicion">
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        modalEdicion.addEventListener("shown.bs.modal", function(event) {
            ...
            // Datos generales
            document.getElementById("edit-descripcion").value = button.getAttribute("data-descripcion_condicion");
            document.getElementById("edit-id_condicion").value = button.getAttribute("data-id_condicion");
