...
if ($_POST) {
  ...
  if ($num > 0) {
    ...
    if ($password_bd == $pass_c) {
      ...
      // 8: TÉCNICO COLOMBIA MAYOR, 9: CONTRATISTA COLOMBIA MAYOR, 10: CONTRATISTA CENTRO VIDA, 11: INGENIERO CENTRO VIDA
      if (in_array($row['tipo_usuario'], [1, 2, 3, 4, 5, 8, 9, 10, 11,12])) {
